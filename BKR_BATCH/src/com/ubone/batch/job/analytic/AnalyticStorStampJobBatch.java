...
import com.ubone.batch.job.analytic.service.AnalyticStorStampJobSO;

/** 
 * <pre>
 *  파 일 명  : AnalyticStorStampJobBatch.java
 *  설    명   : 매장별 스탬프 적립현황 데이터 적재 배치 인스턴스 클래스
 *  작 성 자  : 
 *  작 성 일  : 2018-12-20
 *  버    전   : 1.0
 *  수정이력 :
 ...
 */
@Component
public class AnalyticStorStampJobBatch extends BaseBatch  {

	@Resource
	AnalyticStorStampJobSO analyticStorStampJobSO;
	...
	public int execute(String[] args) throws Exception{
		...
		// 1. 매장별 스탬프 적재
		nCount = analyticStorStampJobSO.changeStorStamp();
	...
	public static void main(String[] args) {
		...
		BaseBatch batch = context.getBean(AnalyticStorStampJobBatch.class);
		batch.run();
	}
}
