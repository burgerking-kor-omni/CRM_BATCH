...
/** 
 * <pre>
 *  파 일 명  : CouponJobAlwaysBatch.java
 *  설    명   : [다우] 실시간 쿠폰핀 발행요청 배치 인스턴스 클래스
 *  작 성 자  : 
 *  작 성 일  : 2018-11-19
 *  버    전   : 1.0
 *  수정이력 :
 ...
 */
@Component
public class CouponJobAlwaysBatch extends BaseBatch  {
	...
	public int execute(String[] args) throws Exception{
		...
		couponJobEX.publishCouponAlways();
		
		// 1. [다우] 실시간 쿠폰핀 발행
//		DataList dt = couponJobSO.publishCouponAlways();
//		
//		if (0 < dt.getRowCount()) {
...
//		}
	...
	public static void main(String[] args) {
		...
		BaseBatch batch = context.getBean(CouponJobAlwaysBatch.class);
		batch.run();
	}
}
