...
/** 
 * <pre>
 *  파 일 명  : CouponFirstJobBatch.java
 *  설    명   : [다우]신규 쿠폰 초기 핀 발행 배치 인스턴스 클래스
 *  작 성 자  : 
 *  작 성 일  : 2018-11-19
 *  버    전   : 1.0
 *  수정이력 :
 ...
 */
@Component
public class CouponFirstJobBatch extends BaseBatch  {
	...
	public int execute(String[] args) throws Exception{
		...
		couponJobEX.publishCouponFirst();
		
		// 1. [다우]신규 쿠폰 초기 핀 발행
//		DataList dt = couponJobSO.publishCouponFirst();
//		
//		if (0 < dt.getRowCount()) {
...
//		}
	...
	public static void main(String[] args) {
		...
		BaseBatch batch = context.getBean(CouponFirstJobBatch.class);
		batch.run();
	}
}
