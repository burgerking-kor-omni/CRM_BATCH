...
/** 
 * <pre>
 *  파 일 명  : GradeDownJobBatch.java
 *  설    명   : 회원등급하향 배치 인스턴스 클래스
 *  작 성 자  : 
 *  작 성 일  : 2018-11-09
 *  버    전   : 1.0
 *  수정이력 :
 ...
 */
@Component
public class GradeDownJobBatch extends BaseBatch  {
	...
	public int execute(String[] args) throws Exception{
		...
		// 1. 회원등급 하향
		gradeJobSO.updateGradeDownTarget();
	...
	public static void main(String[] args) {
		...
		BaseBatch batch = context.getBean(GradeDownJobBatch.class);
		batch.run();
	}
}
